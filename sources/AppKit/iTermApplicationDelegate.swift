    ...
    func registerMenuTips() {
        ...
        let tips = [
            ...
            Tip(identifier: "Edit.Actions",
                ...
                text: "Actions are saved instructions for gjTerm2. For example, you could create an action that opens a new window and then creates a split pane."),
            ...
            Tip(identifier: "Toolbelt.Paste History",
                text: "**Paste History** shows text that you have copied and pasted in gjTerm2. You can configure it to be saved long term."),
            ...
            Tip(identifier: "Always Show Alerts with Remembered Selections",
                text: "When you check **Suppress this message permanently** or **Remember my choice** in an alert, gjTerm2 stops showing that alert and automatically reuses your saved response. Enabling this temporarily ignores those remembered selections so the alerts appear again, letting you see them or make a different choice. It stays on until you turn it back off."),
            ...
            Tip(identifier: "Open Interactive Window",
                text: "The Python REPL opens a window running a special Python interpreter that lets you experiment with gjTerm2’s Python API. You can use `await` at the top level of the interpreter."),
            ...
            Tip(identifier: "Install Python Runtime",
                text: "gjTerm2’s Python Runtime is a large binary package (hundreds of MBs) that enables the Python API by installing a pre-built Python environment that scripts can use."),
            ...
            Tip(identifier: "Install Shell Integration",
                text: "**Shell Integration** consists of shell scripts that run when you log in. They inform gjTerm2 of where your shell prompt is. This enables dozens of useful features such as command history, directory history, AI features, and more."),
